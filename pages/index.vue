<template>
  <div>
    <div class="bg-[url('/img/fond.png')] bg-fixed w-full min-h-screen h-fit bg-cover pt-10 relative">
      ...
      <NavMenu @phoneDisplay="togglePhoneNav"/>

      <div class="block text-center pb-44">
        <IconsArrow color="white" class="block m-auto mt-24 animate-bounce" />

        <TitlesSides class="mt-16">
      ...
      <NuxtLink to="#about-me" class="block mx-auto absolute bottom-10 left-0 right-0 cursor-pointer border border-solid border-white rounded-full w-fit">
        <IconsArrow color="white" class="animate-[transformTopBottom_1s_ease] my-1.5 px-1 sm:px-0 sm:mx-1 sm:my-2.5" />
      </NuxtLink>
    </div>
  </div>
  ...
  <div class="bg-gradient-to-b from-[#161B1F] to-[#010204] w-full h-fit relative overflow-hidden" :class="this.isPhoneNavDisplay ? 'hidden' : 'block'">
    ...
    <div class="pt-20 px-10 md:px-20 relative scroll-smooth max-w-[1920px] w-fit mx-auto" id="about-me">
          ...
          <div class="mx-0 sm:mx-10 lg:mx-40 xl:mx-0 mt-12 xl:mt-0">
            ...
            <div class="md:flex md:justify-between md:items-center mt-8">
              <div class="flex gap-x-6 justify-center md:justify-normal">
                <NuxtLink to="https://www.linkedin.com/in/erwan-nicolas-79729029a/" target="_blank" class="hover:-translate-y-1 duration-300">
                  <IconsLinkedin color="white" />
                </NuxtLink>

                <NuxtLink to="https://github.com/NicoDev99" target="_blank" class="hover:-translate-y-1 duration-300">
                  <IconsGithub color="white" />
                </NuxtLink>
              </div>
      ...
      <div class="mt-32">
        ...
        <!-- Experiences -->
        <TitlesSides class="mb-8">
          <h1 class="font-ZenOldMincho text-white text-3xl">Expérience Pro</h1>
        </TitlesSides>

        <div class="w-fit mx-auto relative">
          <IconsSatellites width="200" height="200" color="white" class="-rotate-90 hidden xl:block translate-x-20 translate-y-10"/>

          <Experience number="1" orientation="left" class="translate-x-0 xl:translate-x-48 2xl:translate-x-64 mb-40 xl:mb-0 mt-24 xl:mt-0">
          ...
          <Experience number="2" orientation="right" class="translate-x-0 xl:-translate-x-52 2xl:-translate-x-64 mt-10 mb-40 xl:mb-0">
          ...
          <Experience number="3" orientation="left" class="translate-x-0 xl:translate-x-48 2xl:translate-x-64 mt-10 mb-40 xl:mb-0">
            <div class="text-white w-full max-w-lg 2xl:max-w-xl" data-aos="fade-right">
              <div class="mb-3">
        ...
        <!-- Formations -->
        <TitlesSides class="my-32">
          <h1 class="font-ZenOldMincho text-white text-3xl">Formations</h1>
        </TitlesSides>

        <div class="w-fit mx-auto relative">

          <Experience number="4" orientation="right" class="translate-x-0 xl:-translate-x-52 2xl:-translate-x-64 mt-10 mb-40 xl:mb-0">
            <div class="text-white w-full max-w-lg 2xl:max-w-xl" data-aos="fade-left">
              <div class="mb-3">
          ...
          <Experience number="5" orientation="left" class="translate-x-0 xl:translate-x-48 2xl:translate-x-64 mt-10 mb-40 xl:mb-0">
            <div class="text-white w-full max-w-lg 2xl:max-w-xl" data-aos="fade-right">
              <div class="mb-3">
          ...
          <Experience number="6" orientation="right" class="translate-x-0 xl:-translate-x-52 2xl:-translate-x-64 mt-10 mb-40 xl:mb-0">
            <div class="text-white w-full max-w-lg 2xl:max-w-xl" data-aos="fade-left">
              <div class="mb-3">
          ...
          <IconsSatellitesDish width="175" height="175" color="white" class="-rotate-90 absolute right-24 hidden xl:block"/>
        </div>
      </div>
    </div>
    ...
    <div class="mt-44 md:mt-96 mx-10 relative max-w-[1920px] lg:mx-auto" id="skills">
      ...
      <div class="md:grid md:grid-cols-2 mx-0 lg:mx-20 2xl:mx-64 md:gap-x-14 lg:gap-x-28 mt-10">
        <ProgressLinear firstColor="#F16529" endColor="#2965F1" progress="90" name="HTML / CSS" class="mt-16"/>
        <Progress color="#8993C1" progress="90" name="PHP" class="mt-16" />
        <Progress color="#CF649B" progress="70" name="SASS / SCSS" class="mt-16" />
        <Progress color="#339ADB" progress="80" name="SQL" class="mt-16" />
        <Progress color="#4DB0B4" progress="90" name="TailWindCSS" class="mt-16" />
        <ProgressLinear firstColor="#D10A77" endColor="#9E28F8" progress="50" name="InfluxDB" class="mt-16"/>
        <Progress color="#FCD329" progress="70" name="JavaScript" class="mt-16" />
        <Progress color="#FE2C21" progress="70" name="Laravel" class="mt-16"/>
        <Progress color="#FE767A" progress="50" name="ChartJS" class="mt-16" />
        <Progress color="#A3EDBA" progress="50" name="Highcharts" class="mt-16" />
        <Progress color="#AF1F1F" progress="70" name="Java" class="mt-16" />
        <ProgressLinear firstColor="#FFDF58" endColor="#3573A4" progress="70" name="Python" class="mt-16"/>
        <ProgressLinear firstColor="#9D68AB" endColor="#5571B5" progress="50" name="Git / GitHub" class="mt-16"/>
        <ProgressLinear firstColor="#809DC9" endColor="#B32024" progress="70" name="SVN / Redmine" class="mt-16"/>
        <Progress color="#2A6914" progress="70" name="VueJS / NuxtJS" class="mt-16" />
        <Progress color="#1A58CF" progress="50" name="TypeScript" class="mt-16" />
        <Progress color="#2B9DDD" progress="50" name="Docker" class="mt-16" />
        <Progress color="#A259FF" progress="80" name="Figma" class="mt-16" />
      </div>

      <div class="flex items-center mt-24 ml-12">
        <IconsSatellites width="125" height="125" color="rgba(255, 255, 255, 0.5)" class="-rotate-[135deg] hidden md:block"/>
        ...
        <div class="flex flex-col lg:flex-row items-center lg:justify-between gap-y-16 lg:gap-y-0 lg:gap-x-10 relative max-w-screen-2xl w-full lg:w-fit mx-auto mt-24 lg:mt-0">
          ...
          <div class="flex gap-x-5 absolute lg:right-0 -top-16">
            <div class="bg-[#1E1E1E]/50 w-10 h-10 relative cursor-not-allowed">
              <IconsArrow color="rgba(255, 255, 255, 0.5)" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rotate-90"/>
            </div>
            <div class="bg-[#1E1E1E]/50 w-10 h-10 relative cursor-not-allowed">
              <IconsArrow color="rgba(255, 255, 255, 0.5)" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 -rotate-90"/>
            </div>
    ...
    <div class="mt-64 relative max-w-[1920px] mx-auto pb-40" id="contact">
      ...
      <div class="max-w-3xl mx-10 md:mx-auto mt-10">
        ...
        <div class="w-full relative">
          <input type="email" class="bg-[#282828] px-5 py-3 outline outline-0 text-white font-Roboto block w-full relative z-0" :class="this.error['email'] ? 'border border-solid border-red-500' : ''" id="email" v-model="this.email" @focus="this.error['email'] = null, this.error['main'] = null, this.success = ''">
        ...
        <div class="w-full relative mt-12">
          <input type="text" class="bg-[#282828] px-5 py-3 outline outline-0 text-white font-Roboto block w-full relative z-0" :class="this.error['subject'] ? 'border border-solid border-red-500' : ''" id="subject" v-model="this.subject" @focus="this.error['subject'] = null, this.error['main'] = null, this.success = ''">
        ...
        <div class="w-full relative mt-12">
          <textarea class="bg-[#282828] px-5 py-3 outline outline-0 text-white font-Roboto block w-full mt-10 min-h-72 z-0" :class="this.error['message'] ? 'border border-solid border-red-500' : ''" id="message" v-model="this.message" @focus="this.error['message'] = null, this.error['main'] = null, this.success = ''"></textarea>
  ...
  <div class="w-full bg-white py-5 px-10 flex flex-col gap-y-5 sm:flex-row sm:justify-between sm:items-center text-center z-10" :class="this.isPhoneNavDisplay ? 'hidden' : 'block'">
    <p class="font-Roboto text-[#4E4E4E] text-sm">{{ "Copyright &copy " + new Date().getFullYear() + " Erwan Nicolas" }}</p>
    <NuxtLink to="/CGU" class="font-Roboto text-[#4E4E4E] text-sm">Conditions Générales d'Utilisation</NuxtLink>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /**
       * Switch the phone menu (hidden to visible and inversly)
       *
       * @return {void}
       */
